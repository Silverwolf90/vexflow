...
Vex.Flow.StemmableNote = (function(){
  ...
  Vex.Inherit(StemmableNote, Vex.Flow.Note, {
    ...
    getStemX: function() {
      ...
      var x_end = this.getAbsoluteX() + this.x_shift + this.getNoteHeadWidth();

      var stem_x = this.stem_direction == Stem.DOWN ?
        x_begin : x_end;

      stem_x -= ((Stem.WIDTH / 3) * this.stem_direction);
    ...
    getCenterGlyphX: function(){
      return this.getAbsoluteX() + this.x_shift + (this.getNoteHeadWidth() / 2);
    },
