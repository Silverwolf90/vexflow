...
Vex.Flow.Test.Beam.Start = function() {
  ...
  Vex.Flow.Test.runTest("Cross Stave Beam - Stem Up", Vex.Flow.Test.Beam.crossStaveStemUp);
  Vex.Flow.Test.runTest("Cross Stave Beam - Stem Down", Vex.Flow.Test.Beam.crossStaveStemDown);
  Vex.Flow.Test.runTest("Cross Stave Beam - Opposite Stems", Vex.Flow.Test.Beam.crossStaveOppositeStems);
...
Vex.Flow.Test.Beam.crossStave = function(options, contextBuilder) {
  var ctx = new contextBuilder(options.canvas_sel, 450, 250);
  ctx.scale(0.9, 0.9); ctx.fillStyle = "#221"; ctx.strokeStyle = "#221";
  ctx.font = " 10pt Arial";
...
Vex.Flow.Test.Beam.crossStaveStemUp = function(options, contextBuilder) {
  var ctx = new contextBuilder(options.canvas_sel, 450, 210);
  ctx.scale(0.9, 0.9); ctx.fillStyle = "#221"; ctx.strokeStyle = "#221";
  ctx.font = " 10pt Arial";
  var stave = new Vex.Flow.Stave(10, 10, 450).addClef('treble').
    setContext(ctx).draw();
  var stave2 = new Vex.Flow.Stave(10, 100, 450).addClef('bass').
    setContext(ctx).draw();

  var notes = [
    newNote({ clef: "bass", keys: ["c/3"], stem_direction: 1, duration: "32"}).setStave(stave2),
    newNote({ clef: "bass",  keys: ["d/3"], stem_direction: 1, duration: "32"}).setStave(stave2),
    newNote({ clef: "bass", keys: ["e/3"], stem_direction: 1, duration: "32"}).setStave(stave2),
    newNote({ clef: "bass", keys: ["f/3"], stem_direction: 1, duration: "32"}).setStave(stave2),
    newNote({ clef: "bass", keys: ["g/3"], stem_direction: 1, duration: "32"}).setStave(stave2),
    newNote({ clef: "bass", keys: ["a/3"], stem_direction: 1, duration: "32"}).setStave(stave2),
    newNote({ clef: "bass", keys: ["b/3"], stem_direction: 1, duration: "32"}).setStave(stave2),
    newNote({ clef: "bass",  keys: ["c/4"], stem_direction: 1, duration: "32"}).setStave(stave2),

    newNote({ clef: "treble", keys: ["d/4"], stem_direction: 1, duration: "32"}).setStave(stave),
    newNote({ clef: "treble",  keys: ["e/4"], stem_direction: 1, duration: "32"}).setStave(stave),
    newNote({ clef: "treble", keys: ["f/4"], stem_direction: 1, duration: "32"}).setStave(stave),
    newNote({ clef: "treble", keys: ["g/4"], stem_direction: 1, duration: "32"}).setStave(stave),
    newNote({ clef: "treble", keys: ["a/4"], stem_direction: 1, duration: "32"}).setStave(stave),
    newNote({ clef: "treble", keys: ["b/4"], stem_direction: 1, duration: "32"}).setStave(stave),
    newNote({ clef: "treble", keys: ["c/5"], stem_direction: 1, duration: "32"}).setStave(stave),
    newNote({ clef: "treble",  keys: ["d/5"], stem_direction: 1, duration: "32"}).setStave(stave)
  ];
  ...
  var beam = new Vex.Flow.Beam(notes.slice(0, 20));
...
Vex.Flow.Test.Beam.crossStaveOppositeStems = function(options, contextBuilder) {
  var ctx = new contextBuilder(options.canvas_sel, 450, 210);
  ctx.scale(0.9, 0.9); ctx.fillStyle = "#221"; ctx.strokeStyle = "#221";
  ctx.font = " 10pt Arial";
  var stave = new Vex.Flow.Stave(10, 10, 450).addClef('treble').
  ...
  var beam = new Vex.Flow.Beam(notes.slice(0, 20)).breakSecondaryAt([4, 7]);
...
Vex.Flow.Test.Beam.crossStaveStemDown = function(options, contextBuilder) {
  var ctx = new contextBuilder(options.canvas_sel, 450, 210);
  ctx.scale(0.9, 0.9); ctx.fillStyle = "#221"; ctx.strokeStyle = "#221";
  ctx.font = " 10pt Arial";
  var stave = new Vex.Flow.Stave(10, 10, 450).addClef('treble').
...
Vex.Flow.Test.Beam.crossStaveComplex = function(options, contextBuilder) {
  ...
  ctx.scale(0.9, 0.9); ctx.fillStyle = "#221"; ctx.strokeStyle = "#221";
  ctx.font = " 10pt Arial";
  var stave = new Vex.Flow.Stave(10, 10, 550).addClef('treble').
    setContext(ctx).draw();
  var stave2 = new Vex.Flow.Stave(10, 150, 550).addClef('bass').
    setContext(ctx).draw();
  ...
  var notes = [
    ...
    newNote({ clef: "bass", keys: ["c/3"], stem_direction: 1, duration: "32"}).setStave(stave2),
    newNote({ clef: "treble",  keys: ["e/4"], stem_direction: -1, duration: "32"}).setStave(stave),
    newNote({ clef: "treble",  keys: ["e/4"], stem_direction: -1, duration: "16"}).setStave(stave)
  ];
  ...
  var beam3 = new Vex.Flow.Beam(notes.slice(10, 15));
  var beam4 = new Vex.Flow.Beam(notes.slice(15, 20));
